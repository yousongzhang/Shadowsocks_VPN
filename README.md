...
A:install outline manager and  run one line bash commond line (then docker which contains ss_server and react API for outline mange auto install on ubuntu system) 
